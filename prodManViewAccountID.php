            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Account: <b><?php echo $id; ?></b> </h4>
                            </div>   
...
if (isset($_GET['id'])){
    ...
    <td><b>{$row['CRepUsername']}</div></b></td>
...
<form action = "prodManViewAccounts.php?id=<?php echo $id; ?>" method = "POST">
    ...
    <a href="prodManViewAccounts.php"><button type="submit" class="btn btn-default btn-fill pull-right">Back to Accounts</button></a>
